...
function ProfileInfo () {
    return(
        <>
            <button className="edit-btn profile-card-edit-btn">X</button>
            ...
            <div id="showcase-services-container">
                <p id="showcase-your-services-p-tag" ><b>Showcase your services</b> as a section on your profile so your business can be easily discovered.</p>
                <h4 id="get-started-tag" ><a href="#">Get started</a></h4>
                <button className="edit-btn edit-btn-open-to-work-con edit-btn-showcase-services">X</button>
            </div>
        </>
    )
}
